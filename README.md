...
[![Detection](https://img.shields.io/badge/detection-147%2F147-brightgreen.svg)](#measured-not-asserted)
...
| Benchmark | Result |
|---|---|
| Invariant unit tests | **977/977** — every case pins a promise a docstring makes |
| Detection, against `fixtures/` | **147/147**, plus **5/5** semantic cross-checks |
