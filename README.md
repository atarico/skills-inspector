...
[![Detection](https://img.shields.io/badge/detection-144%2F144-brightgreen.svg)](#measured-not-asserted)
...
| Benchmark | Result |
|---|---|
| Invariant unit tests | **882/882** — every case pins a promise a docstring makes |
| Detection, against `fixtures/` | **144/144**, plus **5/5** semantic cross-checks |
