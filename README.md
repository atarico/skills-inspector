...
[![Detection](https://img.shields.io/badge/detection-141%2F141-brightgreen.svg)](#measured-not-asserted)
...
| Benchmark | Result |
|---|---|
| Invariant unit tests | **805/805** — every case pins a promise a docstring makes |
