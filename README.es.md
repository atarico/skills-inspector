...
[![Detección](https://img.shields.io/badge/detecci%C3%B3n-141%2F141-brightgreen.svg)](#medido-no-afirmado)
...
| Benchmark | Resultado |
|---|---|
| Tests unitarios de invariantes | **805/805** — cada caso fija una promesa que hace un docstring |
| Detección, contra `fixtures/` | **141/141**, más **5/5** contrastes semánticos |
