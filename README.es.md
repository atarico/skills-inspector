...
[![Detección](https://img.shields.io/badge/detecci%C3%B3n-144%2F144-brightgreen.svg)](#medido-no-afirmado)
...
| Benchmark | Resultado |
|---|---|
| Tests unitarios de invariantes | **882/882** — cada caso fija una promesa que hace un docstring |
| Detección, contra `fixtures/` | **144/144**, más **5/5** contrastes semánticos |
